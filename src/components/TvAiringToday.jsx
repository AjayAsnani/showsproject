...
export default function TVAiringToday() {
  ...
  async function getMoviesFromAPI() {
    const res = await fetch(
      `https://api.themoviedb.org/3/tv/airing_today?api_key=04c35731a5ee918f014970082a0088b1&page=${currentPage}`
    )
  ...
  return (
    <div>
      <br></br>
      <div className='airing-today'><h1>TV AIRING TODAY!</h1></div>
      <br></br>
      <Flex
        direction='column'
